...
class SpaceXRepository extends SpaceXSource {
  ...
  @override
  Future getCapsules(Map<String, dynamic> params) =>
      apiClient.getCapsules(params);

  @override
  Future getCores(Map<String, dynamic> params) => apiClient.getCores(params);
  ...
  @override
  Future getMissions(Map<String, dynamic> params) =>
