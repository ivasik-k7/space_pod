...
mixin _$LaunchLinks {
  ...
  String get redditCampaign => throw _privateConstructorUsedError;
  @JsonKey(name: 'reddit_launch')
  String get redditLaunch => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      missionPatch: missionPatch == freezed
          ...
          : missionPatch // ignore: cast_nullable_to_non_nullable
              as String,
      redditCampaign: redditCampaign == freezed
          ? _value.redditCampaign
          : redditCampaign // ignore: cast_nullable_to_non_nullable
              as String,
      redditLaunch: redditLaunch == freezed
          ? _value.redditLaunch
...
class _$_LaunchLinks implements _LaunchLinks {
  const _$_LaunchLinks(
      ...
      @JsonKey(name: 'reddit_campaign') required this.redditCampaign,
      @JsonKey(name: 'reddit_launch') required this.redditLaunch,
      @JsonKey(name: 'presskit') required this.pressKit,
      @JsonKey(name: 'article_link') required this.articleLink,
      @JsonKey(name: 'video_link') required this.videoLink,
      @JsonKey(name: 'flickr_images') required this.images});

  factory _$_LaunchLinks.fromJson(Map<String, dynamic> json) =>
      _$_$_LaunchLinksFromJson(json);
  ...
  @override
  String toString() {
    return 'LaunchLinks(missionPatch: $missionPatch, redditCampaign: $redditCampaign, redditLaunch: $redditLaunch, pressKit: $pressKit, articleLink: $articleLink, videoLink: $videoLink, images: $images)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _LaunchLinks &&
            ...
            (identical(other.redditCampaign, redditCampaign) ||
                const DeepCollectionEquality()
                    .equals(other.redditCampaign, redditCampaign)) &&
            (identical(other.redditLaunch, redditLaunch) ||
                const DeepCollectionEquality()
                    .equals(other.redditLaunch, redditLaunch)) &&
            (identical(other.pressKit, pressKit) ||
                const DeepCollectionEquality()
                    .equals(other.pressKit, pressKit)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(missionPatch) ^
      const DeepCollectionEquality().hash(redditCampaign) ^
      const DeepCollectionEquality().hash(redditLaunch) ^
  ...
  Map<String, dynamic> toJson() {
    return _$_$_LaunchLinksToJson(this);
  }
}
